...
function ToggleSwitch({ checked, onChange, disabled = false }) {
	return (
		<label className='relative inline-flex items-center cursor-pointer'>
			...
			/>
			<div
				className={`w-11 h-6 bg-slate-200 dark:bg-slate-700 
                peer-focus:outline-none rounded-full peer 
                peer-checked:after:translate-x-full peer-checked:after:border-white 
                after:content-[''] after:absolute after:top-[2px] after:left-[2px] 
                after:bg-white after:border-slate-300 dark:after:border-slate-600 
...
function SettingsCard({ children, className = "" }) {
	return (
		<div
			className={`p-6 rounded-xl bg-white dark:bg-slate-900 border 
            border-slate-200/50 dark:border-slate-800/50 ${className}`}
		>
			{children}
		</div>
	);
								...
								<div className='flex flex-col divide-y divide-slate-200 dark:divide-slate-800'>
									<div className='flex items-center justify-between py-4 first:pt-0'>
										<div>
											...
											<p className='text-sm text-slate-500 dark:text-slate-400'>
												...
												and new comments directly in the
												app.
											</p>
										</div>
										<ToggleSwitch
									...
									<div className='flex items-center justify-between py-4'>
										<div>
											...
											<p className='text-sm text-slate-500 dark:text-slate-400'>
												Get important updates delivered
												to your inbox.
											</p>
										</div>
										<ToggleSwitch
									...
									<div className='flex items-center justify-between py-4'>
										<div>
											...
											<p className='text-sm text-slate-500 dark:text-slate-400'>
												Be notified when issues you
												follow change status.
											</p>
										</div>
										<ToggleSwitch
					...
					<div className='flex flex-col gap-4'>
						...
						<div className='p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800'>
							<p className='text-sm text-red-600 dark:text-red-400'>
								<strong>Warning:</strong> All your data,
								including issues, comments, and profile
