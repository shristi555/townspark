...
const successStories = [
	{
		image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBoFPWHOjWTk0DjIuQlgr0ZiyzOGYJUvM1VvgcTZdAF92aPdl9wh770vRqFnfKiRndvBwjryXkAQiVMAgZeMpWAbimg3Aei7cHfwGEWd1CnlslEdePlK3ckTv5zDYYujymBotNUdKFHPMMe0qbZnKfPu6h95CUwU9wFeY5JsF_kbHqd3Ec8BLV8m8ZNbKYS8iDMIut5-f_-mB945Dj3_RSxKTOpJcopiDgErPIBzJ1Wo9ePZYwwvGqAZsdIAJ2boy28_Y6DoluFKVs",
...
const testimonials = [
	{
		image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBLB4AexUKyZjlXBbt5W-Hk3tkdt-dYXR405nl1bU2F708HdEiMhrOm7y_a_j8nnP4ZUStLZgtydly9O1tZnHrqQ6Dd5G5JZx6nbVRTbIc-ZO_92wc6L5NG7716npdFpnsmJdd29OYjDq3TRgvS2tHYamfK7CT1pfNVFUiP3cyP0_yTJNplt1t9Mc41VZqopBJ9sezPL9Y-RMZNd3GnOTOEB-F8rCX_kM5iGwvIzhTSFeqd8uMJTtTIr8bJaQFmhaVNgKDHMzpUels",
		alt: "Profile picture of Laxmi Timsina",
		name: "Laxmi Timsina",
		role: "Resident",
		quote: "It's amazing to see how quickly things get done now. TownSpark makes me feel like I have a real voice in my community.",
	},
	{
		image: "https://lh3.googleusercontent.com/aida-public/AB6AXuC1Mpt0SzRw8NLWXCdHFqyWNCZewA82lRVzZUCx4w7HgVUhpOkf6zOe96OE3hezgkT-BpIsHrpDSpzElN4dvS0-Vcuk-POZfVCHNU1s3Xc-3AFzrl-E9oQsrqeZsbcACR3MZ1RNPE01dwVkJKQD44QlKT7Jqx2CxlajlPi5yRCC9w8MJnJ2LOTFMy0-J7LwnoPQeC70OsXDw10Ky0f-j0GBqwPDKdUDg3r6n6STfl61EvYlMbRnrwJVhBokbjYKcgV0-vEcYXrQ2ko",
		alt: "Profile picture of Ram Bahadur",
		name: "Ram Bahadur",
		role: "City Official",
		quote: "This app has streamlined our workflow. We can now address citizen reports more efficiently than ever before.",
	},
];
		...
		<div className='relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-background-light dark:bg-background-dark'>
					...
					>
						<div className='flex p-6'>
							<p className='text-white tracking-light text-[28px] font-bold leading-tight'>
								Connecting neighbors to build a better
								TownSpark, together.
							</p>
						</div>
					</div>
			...
			<div className='layout-content-container flex flex-col max-w-[960px] flex-1'>
				...
				<p className='text-white text-base font-normal leading-normal pb-3 pt-1 px-4'>
					...
					connection, we can improve the quality of life for all
					residents and build stronger, more responsive communities.
				</p>
			</div>
			...
			<div className='flex gap-4 overflow-x-auto px-4 pb-4 snap-x snap-mandatory scrollbar-hide'>
				{successStories.map((story, index) => (
					<div
						key={index}
						className='flex flex-col min-w-[280px] snap-start'
					>
						<img
